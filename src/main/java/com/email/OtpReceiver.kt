...
fun main() {
    val EMAIL_ADDRESS = "voldemort@besseggen.in"
    val EMAIL_PASSWORD = "ywcmaunznjwmhotc"
    val IMAP_SERVER = "imap.gmail.com"
    val IMAP_PORT = "993"
    val IMAP_PROTOCOL = "imap"
...
//            fromAddress = "nsccl-otp@besseggen.in",
//            subject = "OTP for login to NSE Clearing Applications",
//            pattern = "One Time Password (OTP) for your login into N-MASS is ",
